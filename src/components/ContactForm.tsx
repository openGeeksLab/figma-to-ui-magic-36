  ...
  return <section className="flex h-[1053px] justify-center items-start w-full px-8 py-24 rounded-[28px] max-md:h-auto max-md:px-5 max-md:py-[60px] max-sm:px-4 max-sm:py-10" id="contact">
      <div className="flex w-[1102px] flex-col justify-center items-center gap-8 max-md:w-full">
        ...
        <div className="flex flex-col items-start gap-[5px] w-full">
          ...
          <div className="flex justify-end items-start gap-6 w-full relative bg-[#E5E4E0] p-12 rounded-[28px] max-lg:flex-col max-lg:p-8 max-md:p-6 max-sm:p-5 mx-0 my-[56px] max-lg:mx-0 max-lg:px-0">
            
            {/* Image section - shown above form on mobile/tablet */}
            <div className="w-[414px] h-[577px] relative max-lg:w-full max-lg:h-[300px] max-lg:mb-6 max-lg:order-first">
              <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/0bdaedf6a2b4b249871135b39b9604b32a3debd6?width=826" alt="Wood panel installation example" className="w-[413px] h-[577px] absolute object-cover rounded-[28px] left-0 top-0 max-lg:w-full max-lg:h-[300px] max-lg:relative" />
              <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/31eddc13a4ce4b7976d9a399d6774eed069fcb1f?width=828" alt="Detailed wood panel texture" className="w-[414px] h-[504px] absolute object-cover rounded-[0px_0px_28px_28px] left-0 top-[73px] max-lg:hidden" />
            </div>

            {/* Form section */}
            <form onSubmit={handleSubmit} className="flex w-[544px] flex-col items-start gap-6 max-lg:w-full max-lg:order-last">
