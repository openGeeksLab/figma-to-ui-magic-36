...
const SampleRequestPopup: React.FC<SampleRequestPopupProps> = ({ children }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-5xl w-full h-[650px] p-0 bg-transparent rounded-[28px] overflow-visible border-0">
        <section 
          ...
          aria-modal="true"
        >
          <header className="items-center z-10 flex w-[52px] gap-2.5 h-[52px] bg-white mr-12 p-2.5 rounded-[28px] max-md:mr-2.5">
            <button
              onClick={handleClose}
            ...
            >
              <div className="flex flex-col relative z-10 aspect-[0.753] w-full pt-11">
                <img
                  ...
                  alt=""
                  className="absolute h-full w-full object-cover inset-0 transform -translate-y-[15px]"
                  loading="lazy"
                />
              </div>
            </aside>
