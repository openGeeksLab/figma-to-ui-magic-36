...
const SampleRequestPopup: React.FC<SampleRequestPopupProps> = ({ children }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-5xl w-full h-[650px] p-0 bg-transparent rounded-[28px] overflow-visible border-0 max-md:max-w-[calc(100vw-16px)] max-md:w-[calc(100vw-16px)] max-md:h-[90vh] max-md:mx-2">
        <section 
        ...
        >
          ...
          <main className="shadow-[0px_15px_60px_0px_rgba(0,0,0,0.15)] relative flex gap-6 pt-[var(--sds-size-space-1200,48px)] pr-[var(--sds-size-space-1200,48px)] pb-[var(--sds-size-space-1200,48px)] pl-[var(--sds-size-space-1200,48px)] bg-[#F3F0E7] rounded-[28px] max-md:px-3 max-md:py-6 max-md:gap-0">
            <aside 
