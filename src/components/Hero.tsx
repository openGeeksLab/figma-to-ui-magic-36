...
const Hero = () => {
  ...
  return (
    <section className="w-full h-[844px] relative rounded-[28px] overflow-hidden max-lg:h-[700px] max-md:h-[600px] max-sm:h-[500px]" aria-label="Hero section">
      <Carousel
        ...
        <CarouselContent className="h-full rounded-[28px]">
          <CarouselItem className="h-full">
            <img
              ...
              className="w-full h-[844px] object-cover max-lg:h-[700px] max-md:h-[600px] max-sm:h-[500px]"
            />
          </CarouselItem>
          <CarouselItem className="h-full">
            <img
      ...
      <div className="flex w-[685px] flex-col justify-end items-start absolute h-[425px] left-10 top-[190px] max-lg:w-[600px] max-lg:left-1/2 max-lg:-translate-x-1/2 max-lg:top-[150px] max-md:w-[90%] max-md:h-auto max-md:left-5 max-md:top-[100px] max-sm:w-[calc(100%_-_32px)] max-sm:left-4 max-sm:bottom-10 max-sm:top-auto z-10">
        <div className="flex flex-col items-start gap-[15px] bg-white p-5 rounded-[28px_28px_0px_0px]">
          <h1 className="text-[#454545] text-[42px] font-bold max-lg:text-[36px] max-md:text-[32px] max-sm:text-2xl">
        ...
        <div className="flex flex-col items-start gap-2.5 bg-white p-5 rounded-[0px_0px_28px_28px]">
          <button className="flex w-[326px] h-[52px] justify-center items-center gap-2.5 bg-[#DCB481] px-8 py-[18px] rounded-[28px] max-lg:w-[280px] max-sm:w-full text-[#454545] text-xl font-normal hover:bg-[#c9a373] transition-colors">
            Get a free sample
          </button>
        </div>
      </div>
