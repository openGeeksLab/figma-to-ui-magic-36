...
const About = () => {
        ...
        <Carousel plugins={[plugin.current]} className="w-full h-full" onMouseEnter={plugin.current.stop} onMouseLeave={plugin.current.reset}>
          <CarouselContent className="h-full">
            {images.map((image, index) => <CarouselItem key={index} className="h-full">
                <img src={image.src} alt={image.alt} className="w-full h-full rounded-[28px] object-scale-down" />
              </CarouselItem>)}
          </CarouselContent>
        </Carousel>
  ...
  <div className="flex-1 flex justify-center items-center max-md:w-full max-md:h-[400px]">
    <img src="/lovable-uploads/3ce6cc59-1de5-4737-955d-81985d6afcb6.png" alt="Vision" className="w-[539px] h-[539px] object-cover rounded-[28px] max-lg:w-[400px] max-lg:h-[400px] max-md:w-full max-md:h-[350px]" />
  </div>
  ...
  <div className="flex-1 flex justify-center items-center max-md:w-full max-md:h-[400px]">
    <img src="/lovable-uploads/d1f3649f-8d67-4d19-b1ea-291d1bfc5b02.png" alt="Values" className="w-[539px] h-[539px] object-cover rounded-[28px] max-lg:w-[400px] max-lg:h-[400px] max-md:w-full max-md:h-[350px]" />
  </div>
    </section>
    ...
    <section className="w-full flex justify-between items-center px-8 py-24 gap-12 max-md:flex-col max-md:px-5 max-sm:px-4 max-md:gap-10 max-md:py-[60px] max-sm:py-10">
  <div className="flex-1 flex justify-center items-center max-md:w-full max-md:h-[400px]">
    <img src="/lovable-uploads/11f4848a-da9c-4f0c-b73b-f4b0fd9607a9.png" alt="Sustainability" className="w-[539px] h-[539px] object-cover rounded-[28px] max-lg:w-[400px] max-lg:h-[400px] max-md:w-full max-md:h-[350px]" />
  </div>
  <div className="flex-1 flex flex-col items-start gap-6 max-md:w-full mr-36 max-md:mr-0">
    <h2 className="text-[#454545] text-[42px] font-bold max-md:text-[32px] max-sm:text-2xl">
