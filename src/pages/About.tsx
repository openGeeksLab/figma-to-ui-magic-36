  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="flex flex-col w-full">
        ...
        <section className="flex justify-center items-center gap-12 w-full px-24 py-24 max-md:px-5 max-md:py-[60px] max-sm:px-4 max-sm:py-10 max-md:flex-col max-md:gap-10">
  <img
