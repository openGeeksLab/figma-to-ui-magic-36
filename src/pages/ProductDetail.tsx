...
const ProductDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="px-8 py-4 bg-[#F5F2ED] rounded-2xl mx-8 max-md:px-5 max-sm:px-4 max-md:mx-5 max-sm:mx-4">
        <div className="mx-auto">
          ...
          <button className="bg-white text-[#454545] px-3 py-1 rounded-[12px] text-xs font-medium hover:bg-gray-50 transition-colors">
            Fill the Form
          </button>
        </div>
      </section>
