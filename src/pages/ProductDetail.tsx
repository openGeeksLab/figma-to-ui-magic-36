...
import CalculateOrderPopup from '@/components/CalculateOrderPopup';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 max-sm:gap-4">
            ...
            <div className="space-y-1 overflow-hidden w-full">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 max-sm:grid-cols-3 gap-1 max-sm:gap-0.5 w-full max-w-[50%] max-sm:max-w-full overflow-hidden max-sm:mx-auto">
                   ...
                   >
                      <img 
                        src="/lovable-uploads/f29b49ea-60ca-4c4b-884c-a8882b51e832.png" 
              ...
              <CalculateOrderPopup
                productDetails={{
                  ...
                  surfaceTreatment: selectedSurfaceTreatment,
                  dimension: selectedDimension,
                  colorName: colorNames[selectedColorSwatch]
                }}
              >
