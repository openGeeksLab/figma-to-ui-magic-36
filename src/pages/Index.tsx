      ...
      <div className="flex flex-col items-center w-full bg-white">
        ...
        <main>
          ...
          <section className="flex flex-col items-center gap-16 w-full px-8 py-24 max-md:px-5 max-md:py-[60px] max-sm:px-4 max-sm:py-10">
            ...
            <div className="grid grid-cols-2 gap-16 w-full max-md:grid-cols-1 max-md:gap-10">
              <article className="flex flex-col items-center gap-6 p-8 rounded-lg border border-[#E5E4E0]">
              ...
              <div className="flex flex-col gap-8">
                ...
                <article className="flex flex-col items-center gap-6 p-8 rounded-lg border border-[#E5E4E0]">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <h3 className="text-[#454545] text-center text-xl font-bold">Sustainable Sourcing</h3>
                    <p className="text-[#454545] text-center text-base font-normal leading-[23.36px]">
                      Vivamus scelerisque lacus eget ligula vestibulum mattis.
                    </p>
                  </div>
          ...
          <ContentSection
            title="Effortless installation with unparalleled lightweight superiority"
            highlightedWord="unparalleled"
            description="Using only heat and steam, we've developed an exclusive method that enhances the natural properties of wood to an unprecedented level. By removing moisture from the wood cells, we've created a product that's not only durable and stable but also beautiful and sustainable, all without the use of any chemicals. Our technology is the result of years of research and development, which we're proud to say is the finest and most advanced in the market."
          ...
          <ContentSection
            title="The House at the Top of the Mountain"
            highlightedWord="at the Top"
            description="At an altitude of 6,500 feet, the materials had to be strong enough to withstand the harsh weather conditions, yet lightweight enough to facilitate installation. After extensive testing, they selected Thermowood Ash for its durability, resistance to the elements, and aesthetic appeal. The result is a stunning and functional venue that offered breathtaking views and unforgettable dining experiences."
            imageUrl="https://cdn.builder.io/api/v1/image/assets/TEMP/edb2e8a545dbe9da09796bff94b6df4d376448f7?width=1078"
            imageAlt="Mountain house with thermowood cladding"
            reverse={true}
          />
          ...
          <ContentSection
            ...
            highlightedWord="wood naturally"
            description="Using only heat and steam, we've developed an exclusive method that enhances the natural properties of wood to an unprecedented level. By removing moisture from the wood cells, we've created a product that's not only durable and stable but also beautiful and sustainable, all without the use of any chemicals. Our technology is the result of years of research and development, which we're proud to say is the finest and most advanced in the market."
            imageUrl="https://cdn.builder.io/api/v1/image/assets/TEMP/a198877c4ebc32a9e02e15743f9b5792f6eb3b1d?width=1078"
            imageAlt="Sustainable wood processing facility"
          />
          
          <section className="w-full relative h-[655px] rounded-[28px] max-md:h-[500px]">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/99469a5d7bec7a772eece7e4e3da6594e67fdfee?width=3338"
              alt="Lunawood Thermowood Ca l'Amo Ibiza project"
              className="w-full h-[655px] absolute object-cover rounded-[41px] left-0 top-0"
            />
