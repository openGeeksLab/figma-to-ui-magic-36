...
const Index = () => {
  return <div className="flex w-full max-w-[1728px] flex-col items-center mx-auto my-0 min-h-screen overflow-x-hidden max-lg:max-w-none max-lg:px-6">
      ...
      <div className="flex flex-col items-center w-full bg-white">
        ...
        <main>
          ...
          <section className="flex flex-col items-center gap-16 w-full px-8 py-24 max-lg:px-6 max-lg:py-20 max-md:px-5 max-md:py-[60px] max-sm:px-4 max-sm:py-10">
            <header className="w-[778px] text-[#454545] text-center text-[42px] font-bold max-lg:w-full max-lg:text-[36px] max-md:w-full max-md:text-[32px] max-sm:text-2xl">
              <h2>
            ...
            <div className="flex justify-center items-start w-full max-lg:flex-col max-lg:gap-8 max-md:flex-col max-md:gap-10">
              <article className="flex flex-col items-center gap-6 flex-1 px-5 py-0 border-r-[#E5E4E0] border-r border-solid max-lg:px-0 max-lg:py-5 max-lg:border-r-[none] max-lg:border-b-[#E5E4E0] max-lg:border-b max-lg:border-solid max-md:px-0 max-md:py-5 max-md:border-r-[none] max-md:border-b-[#E5E4E0] max-md:border-b max-md:border-solid">
              ...
              <article className="flex flex-col items-center gap-6 flex-1 px-5 py-0 border-r-[#E5E4E0] border-r border-solid max-lg:px-0 max-lg:py-5 max-lg:border-r-[none] max-lg:border-b-[#E5E4E0] max-lg:border-b max-lg:border-solid max-lg:last:border-b-0 max-md:px-0 max-md:py-5 max-md:border-r-[none] max-md:border-b-[#E5E4E0] max-md:border-b max-md:border-solid last:border-r-0">
                <div aria-hidden="true">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <section className="w-full relative h-[655px] rounded-[28px] max-lg:h-[600px] max-md:h-[600px] max-sm:h-[550px]">
            ...
            <article className="inline-flex flex-col items-start absolute w-[684px] h-[345px] right-[105px] top-[270px] max-lg:w-[calc(100%_-_60px)] max-lg:right-8 max-lg:top-[200px] max-md:w-[calc(100%_-_40px)] max-md:right-5 max-md:top-[150px] max-sm:w-[calc(100%_-_32px)] max-sm:right-4 max-sm:top-[100px]">
              <header className="flex flex-col items-start gap-[15px] w-full bg-white p-5 rounded-[28px_28px_0px_0px]">
                <h2 className="text-[#454545] text-[32px] font-bold max-lg:text-[28px] max-md:text-2xl max-sm:text-xl">
          ...
          <div className="w-full px-8 py-24 max-lg:px-6 max-lg:py-20 max-md:px-5 max-sm:px-4 max-md:py-16 max-sm:py-12 mx-0 my-[56px]">
            <ContactForm />
          </div>
        </main>
